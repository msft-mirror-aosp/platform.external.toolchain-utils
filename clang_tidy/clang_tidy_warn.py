...
# bits. It may be nice to remove those (e.g. anything Java-ish), assuming we
# don't plan on ever running this on things like build logs from ARC++.
...
warn_patterns = [
    ...
    },
    {
        ...
        'option':
            '-encoding',
        'description':
            'Java: Non-ascii characters used, but ascii encoding specified',
    ...
    },
    {
        ...
        'severity':
            Severity.MEDIUM,
        'description':
            'Java: Non-varargs call of varargs method with inexact '
            'argument type for last parameter',
        'patterns': [
            r".*: warning: non-varargs call of varargs method with inexact "
            r"argument type for last parameter"
        ]
    },
    {
        'category':
        ...
        'patterns': [
            r".*: warning: \[unchecked\] unchecked method invocation: .+ in "
            r"class .+"
        ]
    },
    {
    ...
    },
    {
        ...
        'severity':
            Severity.HIGH,
        'description':
            'Use of internal proprietary API',
        'patterns': [
    ...
    },
    {
        ...
        'description': 'Java: This class\'s name looks like a Type Parameter.',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: Field name is CONSTANT_CASE, but field is not static and '
            'final',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: @Multibinds is a more efficient and declarative mechanism '
            'for ensuring that a set multibinding is present in the graph.',
        'patterns': [r".*: warning: \[EmptySetMultibindingContributions\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.LOW,
        'description': 'Java: Prefer assertThrows to ExpectedException',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: This field is only assigned during initialization; '
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: Refactors uses of the JSR 305 @Immutable to Error '
            'Prone\'s annotation',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: Use Java\'s utility functional interfaces instead of '
            'Function<A, B> for primitive types.',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: A private method that does not reference the enclosing '
            'instance can be static',
        'patterns': [r".*: warning: \[MethodCanBeStatic\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.LOW,
        'description': 'Java: C-style array declarations should not be used',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: Source files should not contain multiple top-level class '
            'declarations',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: Avoid having multiple unary operators acting on the same '
            'variable in a method call',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: Package names should match the directory they are declared '
            'in',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: Non-standard parameter comment; prefer `/* paramName= */ '
            'arg`',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.LOW,
        'description': 'Java: Method parameters that aren\'t checked for null '
    ...
    },
    {
        ...
        'severity':
            Severity.LOW,
        'description':
            'Java: Add a private constructor to modules that will not be '
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: Utility classes (only static members) are not designed to '
            'be instantiated and should be made noninstantiable with a '
            'default constructor.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.LOW,
        'description': 'Java: Unused imports',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: Scopes on modules have no function and will soon be an '
            'error.',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: The default case of a switch should appear at the end of '
            'the last statement group',
        'patterns': [r".*: warning: \[SwitchDefault\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.LOW,
        'description': 'Java: Prefer assertThrows to @Test(expected=...)',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: Unchecked exceptions do not need to be declared in the '
            'method signature.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.LOW,
        'description': 'Java: Prefer assertThrows to try/fail',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: Type parameters must be a single letter with an optional '
            'numeric suffix, or an UpperCamelCase name followed by the '
            'letter \'T\'.',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: Constructors and methods with the same name should appear '
            'sequentially with no other code in between. Please re-order or '
            're-name methods.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.LOW,
        'description': 'Java: Unnecessary call to '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.LOW,
        'description': 'Java: Using static imports for types is unnecessary',
    ...
    },
    {
        ...
        'severity': Severity.LOW,
        'description':
            'Java: @Binds is a more efficient and declarative mechanism for '
            'delegating a binding.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Method reference is ambiguous',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: This method passes a pair of parameters through to '
            'String.format, but the enclosing method wasn\'t annotated '
            '@FormatMethod. Doing so gives compile-time rather than run-time '
            'protection against malformed format strings.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Annotations should be positioned after Javadocs, but '
            'before modifiers..',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Arguments are in the wrong order or could be commented '
            'for clarity.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Arrays do not override equals() or hashCode, so '
            'comparisons will be done on reference equality only. If neither '
            'deduplication nor lookup are needed, consider using a List '
            'instead. Otherwise, use IdentityHashMap/Set, a Map from a '
            'library that handles object arrays, or an Iterable/List of '
            'pairs.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Arguments are swapped in assertEquals-like call',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Assertions may be disabled at runtime and do not guarantee '
            'that execution will halt here; consider throwing an exception '
            'instead',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: The lambda passed to assertThrows should contain exactly '
            'one statement',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: This assertion throws an AssertionError if it fails, '
    ...
    },
    {
        ...
        'severity':
            Severity.MEDIUM,
        'description':
            'Java: @AssistedInject and @Inject should not be used on '
            'different constructors in the same class.',
        'patterns': [
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Make toString(), hashCode() and equals() final in '
            'AutoValue classes, so it is clear to readers that AutoValue is '
            'not overriding them',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Classes that implement Annotation must override equals and '
            'hashCode. Consider using AutoAnnotation instead of implementing '
            'Annotation by hand.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Possible sign flip from narrowing conversion',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Importing nested classes/static methods/static fields with '
            'commonly-used names can make code harder to read, because it may '
            'not be clear from the context exactly which type is being '
            'referred to. Qualifying the name with that of the containing '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: instanceof used in a way that is equivalent to a null '
            'check.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: BigDecimal#equals has surprising behavior: it also '
            'compares scale.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: A call to Binder.clearCallingIdentity() should be followed '
            'by Binder.restoreCallingIdentity() in a finally block. Otherwise '
            'the wrong Binder identity may be used by subsequent code.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: This code declares a binding for a common value type '
            'without a Qualifier annotation.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: valueOf or autoboxing provides better time and space '
            'performance',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: ByteBuffer.array() shouldn\'t be called unless '
            'ByteBuffer.arrayOffset() is used or if the ByteBuffer was '
            'initialized using ByteBuffer.wrap() or ByteBuffer.allocate().',
        'patterns': [r".*: warning: \[ByteBufferBackingArray\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Mockito cannot mock final classes',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Duration can be expressed more clearly with different '
            'units',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Logging or rethrowing exceptions should usually be '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Ignoring exceptions and calling fail() is unnecessary, and '
            'makes test output less useful',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Inner class is non-static but does not reference enclosing '
            'class',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Class.newInstance() bypasses exception checking; prefer '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Providing Closeable resources makes their lifecycle '
            'unclear',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: The type of the array parameter of Collection.toArray '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Collector.of() should not use state',
        'patterns': [r".*: warning: \[CollectorShouldNotUseState\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Class should not implement both `Comparable` '
                       'and `Comparator`',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Constructors should not pass the \'this\' reference out in '
            'method invocations, since the object may not be fully '
            'constructed.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: DateFormat is not thread-safe, and should not be used as a '
            'constant field.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Implicit use of the platform default charset, which can '
            'result in differing behaviour between JVM executions or '
            'incorrect behavior if the encoding of the data source doesn\'t '
            'match expectations.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Avoid deprecated Thread methods; read the method\'s '
            'javadoc for details.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Prefer collection factory methods or builders to the '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Empty top-level type declaration',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: equals() implementation may throw NullPointerException '
            'when given null',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Overriding Object#equals in a non-final class by using '
            'getClass rather than instanceof breaks substitutability of '
            'subclasses.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Classes that override equals should also override '
            'hashCode.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: An equality test between objects with incompatible types '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: The contract of #equals states that it should return '
            'false for incompatible types, while this implementation may '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Implementing #equals by just comparing hashCodes is '
            'fragile. Hashes collide frequently, and this will lead to false '
            'positives in #equals.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Calls to ExpectedException#expect should always be '
            'followed by exactly one statement.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: When only using JUnit Assert\'s static methods, you '
            'should import statically instead of extending.',
        'patterns': [r".*: warning: \[ExtendingJUnitAssert\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Switch case may fall through',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: If you return or throw from a finally, then values '
            'returned or thrown from the try-catch block will be ignored. '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Use parentheses to make the precedence explicit',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: This fuzzy equality check is using a tolerance less than '
            'the gap to the next number. You may want a less restrictive '
            'tolerance, or to assert equality.',
        'patterns': [
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Floating point literal loses precision',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Classes extending PreferenceActivity must implement '
            'isValidFragment such that it does not unconditionally return '
            'true to prevent vulnerability to fragment injection attacks.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Subclasses of Fragment must be instantiable via '
            'Class#newInstance(): the class must be public, static and have '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Return value of methods returning Future must be checked. '
            'Ignoring returned Futures suppresses exceptions thrown from the '
            'code that completes the Future.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Calling getClass() on an enum may return a subclass of the '
            'enum type',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Hardcoded reference to /sdcard',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Hiding fields of superclasses may cause confusion and '
            'errors',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Annotations should always be immutable',
        'patterns': [r".*: warning: \[ImmutableAnnotationChecker\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Enums should always be immutable',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: This annotation has incompatible modifiers as specified by '
            'its @IncompatibleModifiers annotation',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: It is confusing to have a field and a parameter under the '
            'same scope that differ only in capitalization.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Including fields in hashCode which are not compared in '
            'equals violates the contract of hashCode.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: The ordering of parameters in overloaded methods should be '
            'as consistent as possible (when viewed from left to right)',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: This for loop increments the same variable in the header '
            'and in the body',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Constructors on abstract classes are never directly '
            '@Injected, only the constructors of their subclasses can be '
            '@Inject\'ed.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Please also override int read(byte[], int, int), otherwise '
            'multi-byte reads from this input stream are likely to be slow.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Casting inside an if block should be plausibly consistent '
            'with the instanceof type',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Expression of type int may overflow before being assigned '
            'to a long',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: This @param tag doesn\'t refer to a parameter of the '
            'method.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: This tag is invalid.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: The documented method doesn\'t actually throw this checked '
            'exception.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Some JUnit4 construct cannot be used in a JUnit3 context. '
            'Convert your class to JUnit4 style to use them.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Test class inherits from JUnit 3\'s TestCase but has '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Never reuse class names from java.lang',
        'patterns': [r".*: warning: \[JavaLangClash\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Suggests alternatives to obsolete JDK classes.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Calls to Lock#lock should be immediately followed by a try '
            'block which releases the lock.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Assignment where a boolean expression was expected; use == '
            'if this assignment wasn\'t expected or add parentheses for '
            'clarity.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Math.abs does not always give a positive result. Please '
            'consider other methods for positive random numbers.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Switches on enum types should either handle all values, or '
            'have a default case.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: The Google Java Style Guide requires that each switch '
            'statement includes a default statement group, even if it '
            'contains no code. (This requirement is lifted for any switch '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: A collection or proto builder was created, but its values '
            'were never accessed.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Modifying a collection while iterating over it in a loop '
            'may cause a ConcurrentModificationException to be thrown.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Multiple calls to either parallel or sequential are '
            'unnecessary and cause confusion.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Constant field declarations should use the immutable type '
            '(such as ImmutableList) instead of the general collection '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Method return type should use the immutable type (such as '
            'ImmutableList) instead of the general collection interface '
            'type (such as List)',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Compound assignments may hide dangerous casts',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Nested instanceOf conditions of disjoint types create '
            'blocks of code that never execute',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Instead of returning a functional type, return the actual '
            'type that the returned function would return and use lambdas at '
            'use site.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: This update of a volatile variable is '
                       'non-atomic',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Static import of member uses non-canonical name',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Constructors should not be annotated with @Nullable since '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Dereference of possibly-null value',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: @Nullable should not be used for primitive types since '
            'they cannot be null',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: void-returning methods should not be annotated with '
            '@Nullable, since they cannot return null',
        'patterns': [r".*: warning: \[NullableVoid\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Calling toString on Objects that don\'t '
                       'override toString() doesn\'t provide useful '
                       'information',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Objects.hashCode(Object o) should not be passed a '
            'primitive value',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Use grouping parenthesis to make the operator precedence '
            'explicit',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: One should not call optional.get() inside an if statement '
            'that checks !optional.isPresent',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: String literal contains format specifiers, but is not '
            'passed to a format method',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: To return a custom message with a Throwable class, one '
            'should override getMessage() instead of toString() for '
            'Throwable.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Varargs doesn\'t agree for overridden method',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: This method is not annotated with @Inject, but it '
            'overrides a method that is annotated with '
            '@com.google.inject.Inject. Guice will inject this method, and it '
            'is recommended to annotate it explicitly.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Detects `/* name= */`-style comments on actual parameters '
            'where the name doesn\'t match the formal parameter',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Preconditions only accepts the %s placeholder in error '
            'message strings',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Passing a primitive array to a varargs method is usually '
            'wrong',
        'patterns': [
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: A field on a protocol buffer was set twice in the same '
            'chained expression.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Protos should not be used as a key to a map, in a set, or '
            'in a contains method on a descendant of a collection. Protos '
            'have non deterministic ordering and proto equality is deep, '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Qualifiers/Scope annotations on @Inject methods don\'t '
            'have any effect. Move the qualifier annotation to the binding '
            'location.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Injection frameworks currently don\'t '
                       'understand Qualifiers in TYPE_PARAMETER or TYPE_USE '
                       'contexts.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: reachabilityFence should always be called inside a '
            'finally block',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Thrown exception is a subtype of another',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Comparison using reference equality instead of value '
            'equality',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: This annotation is missing required modifiers '
                       'as specified by its @RequiredModifiers annotation',
        'patterns': [r".*: warning: \[RequiredModifiers\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Void methods should not have a @return tag.',
        'patterns': [r".*: warning: \[ReturnFromVoid\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Prefer the short-circuiting boolean operators '
                       '&& and || to & and |.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Writes to static fields should not be guarded by instance '
            'locks',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: A static variable or method should be qualified with a '
            'class name, not expression',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Streams that encapsulate a closeable resource should be '
            'closed using try-with-resources',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: String comparison using reference equality instead of '
            'value equality',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: String.split(String) has surprising behavior',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: SWIG generated code that can\'t call a C++ destructor '
            'will leak memory',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Synchronizing on non-final fields is not safe: if the '
            'field is ever updated, different threads may end up locking on '
            'different objects.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Code that contains System.exit() is untestable.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Using @Test(expected=...) is discouraged, since the test '
            'will pass if *any* statement in the test method throws the '
            'expected exception',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Thread.join needs to be surrounded by a loop until it '
            'succeeds, as in Uninterruptibles.joinUninterruptibly.',
        'patterns': [r".*: warning: \[ThreadJoinLoop\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: ThreadLocals should be stored in static fields',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Relying on the thread scheduler is discouraged; see '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Three-letter time zone identifiers are deprecated, may be '
            'ambiguous, and might not do what you intend; the full IANA time '
            'zone ID should be used instead.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: An implementation of Object.toString() should never '
            'return null.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: The actual and expected values appear to be swapped, '
            'which results in poor assertion failure messages. The actual '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Truth Library assert is called on a constant.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Type parameter declaration overrides another type '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Declaring a type parameter that is only used in the '
            'return type is a misuse of generics: operations on the type '
            'parameter are unchecked, it hides unsafe casts at invocations of '
            'the method, and it interacts badly with method overload '
            'resolution.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Avoid hash-based containers of java.net.URL--the '
            'containers rely on equals() and hashCode(), which cause '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Collection, Iterable, Multimap, and Queue do not have '
            'well-defined equals behavior',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Switch handles all enum values: an explicit default case '
            'is unnecessary and defeats error checking for non-exhaustive '
            'switches.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Unnecessary use of grouping parentheses',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Prefer `asSubclass` instead of casting the result of '
            '`newInstance`, to detect classes of incorrect type before '
            'invoking their constructors.This way, if the class is of the '
            'incorrect type,it will throw an exception before invoking its '
            'constructor.',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: This catch block catches an exception and re-throws '
            'another, but swallows the caught exception rather than setting '
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: Java assert is used in test. For testing purposes '
            'Assert.* matchers should be used.',
        'patterns': [r".*: warning: \[UseCorrectAssertInTests\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Non-constant variable missing @Var annotation',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: variableName and type with the same name would refer to '
            'the static field instead of the class',
        'patterns': [r".*: warning: \[VariableNameSameAsType\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.MEDIUM,
        'description': 'Java: Because of spurious wakeups, Object.wait() and '
                       'Condition.await() must always be called in a loop',
    ...
    },
    {
        ...
        'severity': Severity.MEDIUM,
        'description':
            'Java: A wakelock acquired with a timeout may be released by the '
            'system before calling `release`, even after checking '
            '`isHeld()`. If so, it will throw a RuntimeException. Please '
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: AndroidInjection.inject() should always be invoked '
            'before calling super.lifecycleMethod()',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Use of class, field, or method that is not compatible '
            'with legacy Android devices',
        'patterns': [r".*: warning: \[AndroidJdkLibsChecker\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Reference equality used to compare arrays',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Arrays.fill(Object[], Object) called with incompatible '
            'types.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Calling toString on an array does not provide useful '
            'information',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Arrays.asList does not autobox primitive arrays, as one '
            'might expect.',
    ...
    },
    {
        ...
        'severity':
            Severity.HIGH,
        'description':
            'Java: @AssistedInject and @Inject cannot be used on the same '
            'constructor.',
        'patterns': [
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: AsyncCallable should not return a null Future, only a '
            'Future whose result is null.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: AsyncFunction should not return a null Future, only a '
            'Future whose result is null.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: @AutoFactory and @Inject should not be used in the same '
            'type.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Shift by an amount that is out of range',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Object serialized in Bundle may have been flattened to '
            'base type.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: The called constructor accepts a parameter with the same '
            'name and type as one of its caller\'s parameters, but its '
            'caller doesn\'t pass that parameter to it.  It\'s likely that '
            'it was intended to.',
        'patterns': [
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Ignored return value of method that is annotated with '
            '@CheckReturnValue',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: The source file name should match the name of the '
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Incompatible type as argument to Object-accepting Java '
            'collections method',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java:  Implementing \'Comparable<T>\' where T is not '
                       'compatible with the implementing class.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: This comparison method violates the contract',
        'patterns': [r".*: warning: \[ComparisonContractViolated\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Comparison to value that is out of range for '
                       'the compared type',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: @CompatibleWith\'s value is not a type '
                       'argument.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Non-compile-time constant expression passed to parameter '
            'with @CompileTimeConstant type annotation.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Non-trivial compile time constant boolean expressions '
            'shouldn\'t be used.',
    ...
    },
    {
        ...
        'severity':
            Severity.HIGH,
        'description':
            'Java: A conditional expression with numeric operands of '
            'differing types will perform binary numeric promotion of the '
            'operands; when these operands are of reference types, the '
            'expression\'s result may not be of the expected type.',
        'patterns': [
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Compile-time constant expression overflows',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Dagger @Provides methods may not return null unless '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Thread created but not started',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Division by integer literal zero',
        'patterns': [r".*: warning: \[DivZero\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: This method should not be called.',
        'patterns': [r".*: warning: \[DoNotCall\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Empty statement after if',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: == must be used in equals method to check equality to '
            'itself or an infinite loop will occur.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Comparing different pairs of fields/getters in an '
            'equals implementation is probably a mistake.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Method annotated @ForOverride must be protected or '
            'package-private and only invoked from declaring class, or from '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Invalid printf-style format string',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Casting a lambda to this @FunctionalInterface can cause a '
            'behavior change from casting to a functional superinterface, '
            'which is surprising to users.  Prefer decorator methods to this '
            'surprising behavior.',
    ...
    },
    {
        ...
        'severity':
            Severity.HIGH,
        'description':
            'Java: Futures.getChecked requires a checked exception type with '
    ...
    },
    {
        ...
        'severity':
            Severity.HIGH,
        'description':
            'Java: DoubleMath.fuzzyEquals should never be used in an '
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Calling getClass() on an annotation may return a proxy '
            'class',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Calling getClass() on an object of type Class returns the '
            'Class object for java.lang.Class; you probably meant to operate '
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Checks for unguarded accesses to fields and methods with '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Scope annotation on implementation class of '
                       'AssistedInject factory is not allowed',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: A constructor cannot have two @Assisted parameters of the '
            'same type unless they are disambiguated with named @Assisted '
            'annotations.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Although Guice allows injecting final fields, doing so is '
            'disallowed because the injected value may not be visible to '
            'other threads.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: contains() is a legacy method that is equivalent to '
            'containsValue()',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: A binary expression where both operands are the same is '
            'usually incorrect.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Type declaration annotated with @Immutable is not '
            'immutable',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Modifying an immutable collection is guaranteed to throw '
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Passing argument to a generic method with an incompatible '
            'type.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: The first argument to indexOf is a Unicode code point, '
            'and the second is the index to start the search from',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Conditional expression in varargs call contains array and '
            'non-array arguments',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: This method always recurses, and will cause a '
                       'StackOverflowError',
    ...
    },
    {
        ...
        'severity':
            Severity.HIGH,
        'description':
            'Java: A scoping annotation\'s Target should include TYPE and '
            'METHOD.',
        'patterns': [
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Using more than one qualifier annotation on the same '
    ...
    },
    {
        ...
        'severity':
            Severity.HIGH,
        'description':
            'Java: A class can be annotated with at most one scope '
            'annotation.',
        'patterns': [
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Members shouldn\'t be annotated with @Inject if '
                       'constructor is already annotated @Inject',
    ...
    },
    {
        ...
        'severity':
            Severity.HIGH,
        'description':
            'Java: Scope annotation on an interface or abstact class is not '
            'allowed',
        'patterns': [
            r".*: warning: "
            r"\[InjectScopeAnnotationOnInterfaceOrAbstractClass\] .+"
        ]
    },
    {
        'category':
        ...
        'severity':
            Severity.HIGH,
        'description':
            'Java: Scoping and qualifier annotations must have runtime '
            'retention.',
        'patterns': [
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Injected constructors cannot be optional nor have binding '
            'annotations',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: A standard cryptographic operation is used in a mode that '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Invalid syntax used for a regular expression',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Invalid time zone identifier. TimeZone.getTimeZone(String) '
            'will silently return GMT instead of the time zone you intended.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: The argument to Class#isInstance(Object) should not be a '
            'Class',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Log tag too long, cannot exceed 23 characters.',
        'patterns': [r".*: warning: \[IsLoggableTagLength\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Path implements Iterable<Path>; prefer '
                       'Collection<Path> for clarity',
    ...
    },
    {
        ...
        'severity':
            Severity.HIGH,
        'description':
            'Java: jMock tests must have a @RunWith(JMock.class) annotation, '
            'or the Mockery field must have a @Rule JUnit annotation',
        'patterns': [
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Test method will not be run; please correct method '
            'signature (Should be public, non-static, and method name should '
            'begin with "test").',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: This method should be static',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: setUp() method will not be run; please add JUnit\'s '
            '@Before annotation',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: tearDown() method will not be run; please add JUnit\'s '
            '@After annotation',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: This looks like a test method but is not run; please add '
            '@Test and @Ignore, or, if this is a helper method, reduce its '
            'visibility.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: An object is tested for reference equality to itself '
            'using JUnit library.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Abstract and default methods are not injectable with '
            'javax.inject.Inject',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: This pattern will silently corrupt certain byte sequences '
            'from the serialized protocol message. Use ByteString or byte[] '
            'directly',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: This method does not acquire the locks specified by its '
            '@LockMethod annotation',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Loop condition is never modified in loop body.',
        'patterns': [r".*: warning: \[LoopConditionChecker\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Math.round(Integer) results in truncation',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Certain resources in `android.R.string` have names that do '
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Overriding method is missing a call to overridden super '
            'method',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: A terminating method call is required for a test helper '
            'to have any effect.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Use of "YYYY" (week year) in a date pattern without "ww" '
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: A bug in Mockito will cause this test to fail at runtime '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Missing method call for verify(mock) here',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: This class has more than one @Inject-annotated '
            'constructor. Please remove the @Inject annotation from all but '
            'one of them.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: The result of this method must be closed.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: The first argument to nCopies is the number of copies, and '
            'the second is the item to copy',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: @NoAllocation was specified on this method, but something '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Static import of type uses non-canonical name',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: @CompileTimeConstant parameters should be final or '
            'effectively final',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Calling getAnnotation on an annotation that is not '
            'retained at runtime.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: This conditional expression may evaluate to null, which '
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Numeric comparison using reference equality instead of '
            'value equality',
    ...
    },
    {
        ...
        'severity':
            Severity.HIGH,
        'description':
            'Java: Annotations cannot be both Scope annotations and '
            'Qualifier annotations: this causes confusion when trying to use '
            'them.',
        'patterns': [
    ...
    },
    {
        ...
        'description':
            'Java: This method is not annotated with @Inject, but it '
            'overrides a method that is  annotated with @javax.inject.Inject. '
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Declaring types inside package-info.java files is very bad '
            'form',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Method parameter has wrong package',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Detects classes which implement Parcelable but don\'t '
            'have CREATOR',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Literal passed as first argument to '
                       'Preconditions.checkNotNull() can never be null',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: First argument to `Preconditions.checkNotNull()` is a '
            'primitive rather than an object reference',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Using ::equals or ::isInstance as an incompatible '
            'Predicate; the predicate will always return false',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Access to a private protocol buffer field is forbidden. '
            'This protocol buffer carries a security contract, and can only '
            'be created using an approved library. Direct access to the '
            'fields is forbidden.',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Protobuf fields cannot be null.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Comparing protobuf fields of type String using reference '
            'equality',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: To get the tag number of a protocol buffer enum, use '
            'getNumber() instead.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: @Provides methods need to be declared in a Module to have '
            'any effect.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Casting a random number in the range [0.0, 1.0) to an '
            'integer or long always results in 0.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Use Random.nextInt(int).  Random.nextInt() % n can have '
            'negative results',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Return value of android.graphics.Rect.intersect() must be '
            'checked',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java:  Check for non-whitelisted callers to '
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Return value of this method must be used',
        'patterns': [r".*: warning: \[ReturnValueIgnored\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Variable assigned to itself',
        'patterns': [r".*: warning: \[SelfAssignment\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: An object is compared to itself',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Testing an object for equality with itself will always be '
            'true.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: This method must be called with an even number of '
            'arguments.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Comparison of a size >= 0 is always true, did you intend '
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Static and default interface methods are not natively '
            'supported on older Android devices. ',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Calling toString on a Stream does not provide useful '
            'information',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: StringBuilder does not have a char constructor; this '
            'invokes the int constructor.',
        'patterns': [r".*: warning: \[StringBuilderInitWithChar\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: String.substring(0) returns the original String',
        'patterns': [r".*: warning: \[SubstringOfZero\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Suppressing "deprecated" is probably a typo for '
                       '"deprecation"',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Throwing \'null\' always results in a NullPointerException '
            'being thrown.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: isEqualTo should not be used to test an object for '
            'equality with itself; the assertion will never fail.',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Catching Throwable/Error masks failures from fail() or '
            'assert*() in the try block',
        'patterns': [r".*: warning: \[TryFailThrowable\] .+"]
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Type parameter used as type qualifier',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Non-generic methods should not be invoked with type '
            'arguments',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: Instance created but never used',
    ...
    },
    {
        ...
        'severity': Severity.HIGH,
        'description':
            'Java: Collection is modified in place, but the result is not '
            'used',
    ...
    },
    {
        'category': 'java',
        'severity': Severity.HIGH,
        'description': 'Java: `var` should not be used as a type name.',
